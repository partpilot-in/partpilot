...
export const ProductsGrid: React.FC = () => {
  ...
  useEffect(() => {
    const updateVisibleCards = () => {
      ...
      setActiveIndex((current) => Math.min(current, capabilities.length - nextVisibleCards));
    };
  ...
  const carouselOffset = activeIndex === 0
    ? '0px'
  ...
  return (
    <section id="capabilities" className="section">
      <div className="container">
        ...
        <div className="products-carousel" role="region" aria-label="Platform capabilities">
          <div
            className="products-track"
            style={{ '--carousel-offset': carouselOffset } as React.CSSProperties}
          >
        ...
        <div className="products-pagination" aria-label="Capability carousel pages">
