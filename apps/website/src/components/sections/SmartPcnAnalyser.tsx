      ...
      <div className="container agentic-container">
        <div className="agentic-content">
          ...
          <h2 className="section-title">
            Verify supplier change notices beyond the headline
          </h2>
          <p className="agentic-text source-intelligence-text">
            PCNs claim "no change" but PartPilot verifies it. It parses supplier
            change notices, classifies them against J-STD-046 and IPC-1752, and
            cross-checks the change against your component's real parametric
            envelope, not just the datasheet headline.
          </p>
        </div>
        ...
        <div className="agentic-visual">
          <div className="mockup-card pcn-card hover-lift">
            ...
            <div
              className="pcn-table pcn-review-table"
              aria-label="Why this PCN matters"
            >
              ...
              {pcnReviewRows.map((row) => (
                <div key={row.label} className="pcn-table-row">
                  ...
                  <span
                    className={
                      row.flagged
                        ? "pcn-change-badge pcn-flagged"
                        : "pcn-change-badge pcn-unchanged"
                    }
