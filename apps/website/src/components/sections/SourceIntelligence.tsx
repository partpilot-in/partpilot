      ...
      <div className="container agentic-container">
        <div className="agentic-content">
          ...
          <h2 className="section-title">
            Credible source data for supply chain decisions
          </h2>
          <p className="agentic-text source-intelligence-text">
            PartPilot monitors supply chain risk, compliance campaigns, and
            engineering workflows with insights grounded in trusted market,
            regulatory, supplier, and component data. Teams can investigate
            issues in plain language, connect their existing systems, and act on
            findings backed by credible sources.
          </p>
        </div>
